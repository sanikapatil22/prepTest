...
import { Loader2, Search, BookOpen, Plus, Upload, Pencil, Trash2, Globe, Lock } from "lucide-react";
...
export default function CollegeLibraryPage() {
  ...
  const scope = activeTab === "private" ? "private" : "public";
  ...
  }, [scope, search, category, difficulty, type, page]);
  ...
  useEffect(() => {
    fetch(`/api/library/categories?scope=${scope}`)
      .then((res) => res.json())
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Browse public questions or manage your college&apos;s private library.
          </p>
        </div>
          ...
          {isPrivate && (
            <>
              <Button variant="outline" asChild>
                <Link href="/college/library/upload">
                  <Upload className="size-4" />
                  Upload CSV
                </Link>
              </Button>
              <Button asChild>
                <Link href="/college/library/new">
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      {isPrivate && <TableHead className="text-right">Actions</TableHead>}
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {!data || data.questions.length === 0 ? (
                      <TableRow>
                        <TableCell colSpan={isPrivate ? 7 : 6} className="h-24 text-center text-muted-foreground">
                          {isPrivate
                            ? "No questions in your private library yet. Add some!"
                            : "No questions found in the public library."}
                        </TableCell>
                      </TableRow>
                    ) : (
                                ...
                                <AlertDialog>
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      ...
                                      <AlertDialogDescription>
                                        Are you sure? This will permanently remove this question from your library.
                                      </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
